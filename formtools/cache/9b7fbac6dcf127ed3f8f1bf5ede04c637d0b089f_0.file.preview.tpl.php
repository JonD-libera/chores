<?php
/* Smarty version 3.1.31, created on 2021-09-15 13:42:01
  from "/var/www/html/formtools/modules/form_builder/templates/preview.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_61423069efb7e0_76708935',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9b7fbac6dcf127ed3f8f1bf5ede04c637d0b089f' => 
    array (
      0 => '/var/www/html/formtools/modules/form_builder/templates/preview.tpl',
      1 => 1573338112,
      2 => 'file',
    ),
  ),
...
function content_61423069efb7e0_76708935 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_function_views_dropdown')) require_once '/var/www/html/formtools/global/smarty_plugins/function.views_dropdown.php';
if (!is_callable('smarty_function_template_sets')) require_once '/var/www/html/formtools/modules/form_builder/smarty_plugins/function.template_sets.php';
if (!is_callable('smarty_function_display_template_set_templates')) require_once '/var/www/html/formtools/modules/form_builder/smarty_plugins/function.display_template_set_templates.php';
if (!is_callable('smarty_function_display_template_set_placeholders')) require_once '/var/www/html/formtools/modules/form_builder/smarty_plugins/function.display_template_set_placeholders.php';
?>
<!doctype html>
<html>
<head>
...
" />
            ...
            <div class="section">
                <h2 id="main_settings_heading" class="first"><?php echo strtoupper($_smarty_tpl->tpl_vars['LANG']->value['phrase_main_settings']);?>
</h2>
            ...
            <div class="section">
                <h2 id="template_settings_heading">
                    <?php echo strtoupper($_smarty_tpl->tpl_vars['L']->value['word_templates']);?>
            ...
            <div class="section">
                <h2 id="placeholders_heading">
                    <?php echo strtoupper($_smarty_tpl->tpl_vars['L']->value['word_placeholders']);?>
            ...
            <div class="section">
                <h2 id="thankyou_page_heading"><?php echo strtoupper($_smarty_tpl->tpl_vars['L']->value['phrase_thankyou_page_content']);?>
</h2>
                <div id="thankyou_page" style="display:none">
                    <textarea name="thankyou_page_content" id="thankyou_page_content"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['thankyou_page_content']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
</textarea>
            ...
            <div class="section">
                <h2 id="form_offline_heading"><?php echo strtoupper($_smarty_tpl->tpl_vars['L']->value['phrase_form_offline_page_content']);?>
</h2>
                <div id="form_offline" style="display:none">
                    <textarea name="form_offline_page_content" class="monospace" id="form_offline_page_content"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_offline_page_content']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
</textarea>
            ...
            <div class="section">
                <h2 id="advanced_heading"><?php echo strtoupper($_smarty_tpl->tpl_vars['L']->value['phrase_other_settings']);?>
</h2>
                <div id="advanced" class="section_options" style="display:none">
                    <div>
                        ...
                        <div>
                            <input type="text" name="offline_date" id="fod" size="18" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['offline_date']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" />
...
/global/images/calendar.png" id="fod_icon_id" />
                    ...
                    <div>
                        ...
                        <div><input type="text" name="review_page_title" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['review_page_title']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" id="rpt" class="full" /></div>
                    </div>
                    <div>
                        <label for="tpt"><?php echo $_smarty_tpl->tpl_vars['L']->value['phrase_thankyou_page_nav_title'];?>
</label>
                        <div><input type="text" name="thankyou_page_title" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['thankyou_page_title']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" id="tpt" class="full" /></div>
                    </div>
                </div>
            </div>

            <div class="btn apply_btn"><?php echo strtoupper($_smarty_tpl->tpl_vars['L']->value['phrase_apply_changes']);?>
 &raquo;</div>

            
            <input type="hidden" name="filename" id="filename" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_filename']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" />
            <input type="hidden" name="folder_url" id="folder_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_folder_url']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" />
            <input type="hidden" name="folder_path" id="folder_path" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_folder_path']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" />
    ...
    <div id="footer">
        ...
        <?php if ($_smarty_tpl->tpl_vars['is_published']->value == "no") {?>
            <span class="btn publish_btn"><?php echo strtoupper($_smarty_tpl->tpl_vars['L']->value['word_publish']);?>
</span>
        <?php } else { ?>
            <span class="btn publish_settings_btn"><?php echo strtoupper($_smarty_tpl->tpl_vars['L']->value['phrase_publish_settings']);?>
</span>
        <?php }?>
        <span class="btn save_btn"><?php echo strtoupper($_smarty_tpl->tpl_vars['L']->value['word_save']);?>
</span>
        <span class="btn help_btn"><?php echo strtoupper($_smarty_tpl->tpl_vars['LANG']->value['word_help']);?>
</span>
    </div>
  ...
  <div id="publish_form_dialog" style="display:none">
    ...
    <tr>
      ...
      <td>
        <input type="text" id="publish_filename" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_filename']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" <?php if ($_smarty_tpl->tpl_vars['module_settings']->value['demo_mode'] == "on") {?>disabled<?php }?> />.php
    ...
    <tr>
      ...
      <td>
        ...
        <tr>
          <td><input type="text" id="publish_folder_path" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_folder_path']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
...
"
    ...
    <tr>
      ...
      <td>
        <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td><input type="text" id="publish_folder_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_folder_url']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" <?php if ($_smarty_tpl->tpl_vars['module_settings']->value['demo_mode'] == "on") {?>disabled<?php }?> /></td>
...
"
        ...
        <input type="hidden" id="old_publish_folder_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_folder_url']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" />
      </td>
    </tr>
    </table>
  ...
  <div id="publish_settings_form_dialog" style="display:none">
    <div id="publish_settings_display">
      ...
      <tr>
        ...
        <td>
          <input type="text" id="new_publish_filename" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_filename']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" <?php if ($_smarty_tpl->tpl_vars['module_settings']->value['demo_mode'] == "on") {?>disabled<?php }?> />.php
          <input type="hidden" id="old_publish_filename" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_filename']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" />
        </td>
      </tr>
      <tr>
        ...
        <td>
          <table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td><input type="text" id="new_publish_folder_path" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_folder_path']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" <?php if ($_smarty_tpl->tpl_vars['module_settings']->value['demo_mode'] == "on") {?>disabled<?php }?> /></td>
            <?php if ($_smarty_tpl->tpl_vars['module_settings']->value['demo_mode'] != "on") {?>
            <td width="170">
              <input type="button" value="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_test_folder_permissions'];?>
"
          ...
          <input type="hidden" id="old_publish_folder_path" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_folder_path']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" />
        </td>
      </tr>
      <tr>
        ...
        <td>
          <table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td><input type="text" id="new_publish_folder_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['published_folder_url']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" <?php if ($_smarty_tpl->tpl_vars['module_settings']->value['demo_mode'] == "on") {?>disabled<?php }?> /></td>
            <?php if ($_smarty_tpl->tpl_vars['module_settings']->value['demo_mode'] != "on" && $_smarty_tpl->tpl_vars['allow_url_fopen']->value) {?>
              <td width="170"><input type="button" value="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_confirm_folder_url_match'];?>
"
