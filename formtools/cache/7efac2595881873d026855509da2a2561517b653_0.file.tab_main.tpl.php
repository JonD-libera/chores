...
/* Smarty version 3.1.31, created on 2021-09-15 13:41:30
  from "/var/www/html/formtools/themes/default/admin/forms/edit/tab_main.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_6142304abc1455_75328224',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7efac2595881873d026855509da2a2561517b653' => 
    array (
      0 => '/var/www/html/formtools/themes/default/admin/forms/edit/tab_main.tpl',
      1 => 1573338106,
      2 => 'file',
    ),
  ),
...
function content_6142304abc1455_75328224 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_function_ft_include')) require_once '/var/www/html/formtools/global/smarty_plugins/function.ft_include.php';
if (!is_callable('smarty_function_template_hook')) require_once '/var/www/html/formtools/global/smarty_plugins/function.template_hook.php';
if (!is_callable('smarty_function_clients_dropdown')) require_once '/var/www/html/formtools/global/smarty_plugins/function.clients_dropdown.php';
?>
  <div class="subtitle underline margin_top_large"><?php echo strtoupper($_smarty_tpl->tpl_vars['LANG']->value['phrase_main_settings']);?>
</div>
...
" />
 ...
 <?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_accepting_submissions'];?>
    ...
    <tr>
      ...
      <td><input type="text" name="form_name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_info']->value['form_name'], ENT_QUOTES, 'ISO-8859-1', true);?>
" style="width: 99%" /></td>
    </tr>
    <tr>
    ...
    <div id="form_settings__external" class="form_type_specific_options" <?php if ($_smarty_tpl->tpl_vars['form_info']->value['form_type'] != "external") {?>style="display:none"<?php }?>>
      <div class="subtitle underline margin_bottom_large margin_top_large"><?php echo strtoupper($_smarty_tpl->tpl_vars['LANG']->value['phrase_external_form_info']);?>
</div>
...
" style="width: 98%" /></td>
              <td width="60"><input type="button" class="check_url" id="check_url__form_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['LANG']->value['phrase_check_url'], ENT_QUOTES, 'ISO-8859-1', true);?>
" /></td>
            </tr>
            </table>
          </div>
...
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['i']->value['form_url'], ENT_QUOTES, 'ISO-8859-1', true);?>
" /></li>
                          <li class="col3"><input type="button" class="check_url" id="check_url__mp_url_<?php echo $_smarty_tpl->tpl_vars['count']->value;?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['LANG']->value['phrase_check_url'], ENT_QUOTES, 'ISO-8859-1', true);?>
" /></li>
                          <li class="col4 colN del"></li>
                        </ul>
                        <div class="clear"></div>
                    ...
                    <div class="row_content">
                      <div class="row_group rowN">
                        ...
                        <ul>
                          ...
                          <li class="col3"><input type="button" class="check_url" id="check_url__mp_url_0" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['LANG']->value['phrase_check_url'], ENT_QUOTES, 'ISO-8859-1', true);?>
" /></li>
                          <li class="col4 colN del"></li>
                        </ul>
                        <div class="clear"></div>
...
" style="width: 98%" /></td>
              <td width="60"><input type="button" class="check_url" id="check_url__redirect_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['LANG']->value['phrase_check_url'], ENT_QUOTES, 'ISO-8859-1', true);?>
" /></td>
            </tr>
            </table>
          </td>
    ...
    <div class="subtitle underline margin_bottom_large margin_top_large"><?php echo strtoupper($_smarty_tpl->tpl_vars['LANG']->value['phrase_permissions_other_settings']);?>
</div>
...
"
    ...
    <tr>
      ...
      <td><input type="text" name="edit_submission_page_label" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_info']->value['edit_submission_page_label'], ENT_QUOTES, 'ISO-8859-1', true);?>
"
    ...
    <tr>
      ...
      <td>
        <input type="text" name="add_submission_button_label" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_info']->value['add_submission_button_label'], ENT_QUOTES, 'ISO-8859-1', true);?>
"
